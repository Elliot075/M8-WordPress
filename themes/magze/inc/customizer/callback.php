...
if ( ! function_exists( 'magze_is_preloader_enabled' ) ) :
	/**
	 ...
	 */
	function magze_is_preloader_enabled( $control ) {
...
if ( ! function_exists( 'magze_is_progressbar_enabled' ) ) :
	/**
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function magze_is_progressbar_enabled( $control ) {
...
if ( ! function_exists( 'magze_is_header_social_icons_theme_color' ) ) :
	/**
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function magze_is_header_social_icons_theme_color( $control ) {
...
if ( ! function_exists( 'magze_is_top_bar_enabled' ) ) :
	/**
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function magze_is_top_bar_enabled( $control ) {
...
if ( ! function_exists( 'magze_is_todays_time_enabled' ) ) :
	/**
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function magze_is_todays_time_enabled( $control ) {
...
if ( ! function_exists( 'magze_is_todays_date_enabled' ) ) :
	/**
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function magze_is_todays_date_enabled( $control ) {
...
if ( ! function_exists( 'magze_is_menu_bar_logo_available' ) ) :
	/**
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function magze_is_menu_bar_logo_available( $control ) {
...
if ( ! function_exists( 'magze_is_menu_bar_logo_enabled' ) ) :
	/**
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function magze_is_menu_bar_logo_enabled( $control ) {
...
if ( ! function_exists( 'magze_is_ad_banner_enabled' ) ) :
	/**
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function magze_is_ad_banner_enabled( $control ) {
...
if ( ! function_exists( 'magze_is_sticky_menu_enabled' ) ) :
	/**
	 ...
	 * @param WP_Customize_Control $control WP_Customize_Control instance.
	 */
	function magze_is_sticky_menu_enabled( $control ) {
...
if ( ! function_exists( 'magze_is_ticker_posts_enabled' ) ) :
	/**
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function magze_is_ticker_posts_enabled( $control ) {
...
if ( ! function_exists( 'magze_is_ticker_label_enabled' ) ) :
	/**
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function magze_is_ticker_label_enabled( $control ) {
...
if ( ! function_exists( 'magze_is_ticker_posts_category_enabled' ) ) :
	/**
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function magze_is_ticker_posts_category_enabled( $control ) {
...
if ( ! function_exists( 'magze_is_home_banner_enabled' ) ) :
	/**
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function magze_is_home_banner_enabled( $control ) {
...
if ( ! function_exists( 'magze_is_home_banner_as_slider' ) ) :
	/**
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function magze_is_home_banner_as_slider( $control ) {
...
if ( ! function_exists( 'magze_is_home_banner_as_carousel' ) ) :
	/**
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function magze_is_home_banner_as_carousel( $control ) {
...
if ( ! function_exists( 'magze_is_home_banner_not_fullwidth' ) ) :
	/**
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function magze_is_home_banner_not_fullwidth( $control ) {
...
if ( ! function_exists( 'magze_banner_content_from_category' ) ) :
	/**
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function magze_banner_content_from_category( $control ) {
...
if ( ! function_exists( 'magze_banner_content_from_post_ids' ) ) :
	/**
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function magze_banner_content_from_post_ids( $control ) {
...
if ( ! function_exists( 'magze_is_home_banner_arrows_enabled' ) ) :
	/**
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function magze_is_home_banner_arrows_enabled( $control ) {
...
if ( ! function_exists( 'magze_is_banner_overlay_enabled' ) ) :
	/**
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function magze_is_banner_overlay_enabled( $control ) {
...
if ( ! function_exists( 'magze_is_banner_category_enabled' ) ) :
	/**
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function magze_is_banner_category_enabled( $control ) {
...
if ( ! function_exists( 'magze_is_banner_desc_enabled' ) ) :
	/**
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function magze_is_banner_desc_enabled( $control ) {
...
if ( ! function_exists( 'magze_is_banner_read_more_enabled' ) ) :
	/**
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function magze_is_banner_read_more_enabled( $control ) {
...
if ( ! function_exists( 'magze_is_pinned_posts_enabled' ) ) :
	/**
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function magze_is_pinned_posts_enabled( $control ) {
...
if ( ! function_exists( 'magze_is_pinned_overlay_enabled' ) ) :
	/**
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function magze_is_pinned_overlay_enabled( $control ) {
...
if ( ! function_exists( 'magze_pinned_posts_content_from_category' ) ) :
	/**
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function magze_pinned_posts_content_from_category( $control ) {
...
if ( ! function_exists( 'magze_pinned_posts_content_from_post_ids' ) ) :
	/**
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function magze_pinned_posts_content_from_post_ids( $control ) {
...
if ( ! function_exists( 'magze_is_pinned_posts_category_enabled' ) ) :
	/**
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function magze_is_pinned_posts_category_enabled( $control ) {
...
if ( ! function_exists( 'magze_is_trending_posts_enabled' ) ) :
	/**
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function magze_is_trending_posts_enabled( $control ) {
...
if ( ! function_exists( 'magze_is_trending_posts_category_enabled' ) ) :
	/**
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function magze_is_trending_posts_category_enabled( $control ) {
...
if ( ! function_exists( 'magze_is_related_posts_enabled' ) ) :
	/**
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function magze_is_related_posts_enabled( $control ) {
...
if ( ! function_exists( 'magze_is_related_posts_category_enabled' ) ) :
	/**
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function magze_is_related_posts_category_enabled( $control ) {
...
if ( ! function_exists( 'magze_is_related_posts_desc_enabled' ) ) :
	/**
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function magze_is_related_posts_desc_enabled( $control ) {
...
if ( ! function_exists( 'magze_is_related_posts_read_more_enabled' ) ) :
	/**
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function magze_is_related_posts_read_more_enabled( $control ) {
...
if ( ! function_exists( 'magze_is_author_info_enabled' ) ) :
	/**
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function magze_is_author_info_enabled( $control ) {
...
if ( ! function_exists( 'magze_is_author_box_bg_enabled' ) ) :
	/**
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function magze_is_author_box_bg_enabled( $control ) {
...
if ( ! function_exists( 'magze_is_author_posts_enabled' ) ) :
	/**
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function magze_is_author_posts_enabled( $control ) {
...
if ( ! function_exists( 'magze_is_author_posts_category_enabled' ) ) :
	/**
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function magze_is_author_posts_category_enabled( $control ) {
...
if ( ! function_exists( 'magze_is_author_posts_desc_enabled' ) ) :
	/**
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function magze_is_author_posts_desc_enabled( $control ) {
...
if ( ! function_exists( 'magze_is_author_posts_read_more_enabled' ) ) :
	/**
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function magze_is_author_posts_read_more_enabled( $control ) {
...
if ( ! function_exists( 'magze_is_copyright_enabled' ) ) :
	/**
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function magze_is_copyright_enabled( $control ) {
...
if ( ! function_exists( 'magze_is_light_footer' ) ) :
	/**
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function magze_is_light_footer( $control ) {
...
if ( ! function_exists( 'magze_is_dark_footer' ) ) :
	/**
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function magze_is_dark_footer( $control ) {
...
if ( ! function_exists( 'magze_is_footer_bg_enabled' ) ) :
	/**
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function magze_is_footer_bg_enabled( $control ) {
...
if ( ! function_exists( 'magze_is_light_sub_footer' ) ) :
	/**
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function magze_is_light_sub_footer( $control ) {
...
if ( ! function_exists( 'magze_is_dark_sub_footer' ) ) :
	/**
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function magze_is_dark_sub_footer( $control ) {
...
if ( ! function_exists( 'magze_is_footer_social_menu_enabled' ) ) :
	/**
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function magze_is_footer_social_menu_enabled( $control ) {
...
if ( ! function_exists( 'magze_is_posts_on_front' ) ) :
	/**
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function magze_is_posts_on_front( $control ) {
...
if ( ! function_exists( 'magze_is_home_title_enabled' ) ) :
	/**
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function magze_is_home_title_enabled( $control ) {
...
if ( ! function_exists( 'magze_is_archive_read_more_enabled' ) ) :
	/**
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function magze_is_archive_read_more_enabled( $control ) {
...
if ( ! function_exists( 'magze_is_scroll_top_enabled' ) ) :
	/**
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function magze_is_scroll_top_enabled( $control ) {
...
if ( ! function_exists( 'magze_is_light_offcanvas' ) ) :
	/**
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function magze_is_light_offcanvas( $control ) {
...
if ( ! function_exists( 'magze_is_dark_offcanvas' ) ) :
	/**
	 ...
	 * @return bool Whether the control is active to the current preview.
	 */
	function magze_is_dark_offcanvas( $control ) {
