 ...
 * @extends  WP_Widget
 */
abstract class Magze_Widget_Base extends WP_Widget {
	...
	public function __construct() {
		...
		add_action( 'admin_enqueue_scripts', array( $this, 'magze_widget_scripts' ) );
	}
	...
	public function update( $new_instance, $old_instance ) {
		...
		foreach ( $this->settings as $key => $setting ) {
			 ...
			 */
			$instance[ $key ] = apply_filters( 'magze_widget_settings_sanitize', $instance[ $key ], $new_instance, $key, $setting );
		}
	...
	public function form( $instance ) {
		...
		foreach ( $this->settings as $key => $setting ) {
			...
			switch ( $setting['type'] ) {
				...
				default:
					do_action( 'magze_widget_field_' . $setting['type'], $key, $value, $setting, $instance );
					break;
			}
		}
	}
	 ...
	 * @return void
	 */
	public function magze_widget_scripts( $hook ) {
		if ( 'widgets.php' === $hook ) {
			...
			wp_enqueue_media();
			wp_enqueue_style( 'magze_widgets_css', get_template_directory_uri() . '/inc/widgets/widget-base/css/style' . $min . '.css' );
			wp_enqueue_script( 'magze_widgets', get_template_directory_uri() . '/inc/widgets/widget-base/js/script' . $min . '.js', array( 'jquery', 'wp-color-picker' ), _S_VERSION, true );
		}
	}
