...
magze.traverseMenu = {
    init: function () {
        let topNavigation = document.querySelector(".magze-top-nav");
...
magze.handleFocus = {
    ...
    keepFocusInModal: function () {
        let modal = document.querySelectorAll(".magze-canvas-modal");
...
/* Preloader
 **-----------------------------------------------------*/
magze.fadeOutPreloader = {
    init: function () {
        let preloader = document.querySelector("#magze-preloader-wrapper");
        if (preloader) {
...
magze.stickyMenu = {
    init: function () {
        const stickyElement = document.querySelector(
            ".magze-primary-bar-row.sticky-menu"
        );
        if (stickyElement) {
    ...
    handleClickOutsideBox: function (event) {
        ...
        if (document.body.classList.contains("search-block-is-open")) {
            let targetDiv = document.querySelector(
                ".magze-search-toggle.active .em-search-form-inner"
            );
            if (!targetDiv.contains(event.target)) {
                magze.SearchBlock.hideBlock();
            }
        }
    },
...
/* Background Image
 **-----------------------------------------------------*/
magze.setBackgroundImage = {
    init: function () {
        let bgImageContainer = document.querySelectorAll(".magze-bg-image");
        if (bgImageContainer) {
...
magze.progressBar = {
    init: function () {
        let progressBarDiv = document.getElementById("magze-progress-bar");
...
magze.slider = {
    ...
    bannerSlider: function () {
        let sliderWrapper = document.querySelector(".magze-banner-wrapper");
        if (sliderWrapper) {
...
magze.loadPosts = {
    ...
    init: function () {
        ...
        if (loadButtonWrapper) {
            ...
            self.loadButton = document.querySelector(".magze-ajax-load-btn");
            self.loader = document.querySelector(".magze-ajax-loader");
            self.postsListsWrapper =
                document.querySelector(".magze-posts-lists");
    ...
    fetchThePosts: function () {
        ...
        let data = {
            action: "magze_load_posts",
            load_post_nonce: MagzeVars.load_post_nonce,
            query_vars: MagzeVars.query_vars,
            page: self.nextPage,
            template: self.template,
        };
        fetch(MagzeVars.ajaxurl, {
            method: "POST",
            headers: {
            ...
            .then((response) => {
                if (response.success) {
                    ...
                    let newElements =
                        magze.createElementsFromString(contentJoin);
 ...
 *--------------------------------------------------*/
magze.createElementsFromString = function (htmlString) {
...
magzeDomReady(function () {
    magze.stickyMenu.init();
    magze.subMenuToggle.init();
    magze.traverseMenu.init();
    magze.handleFocus.init();
    magze.CanvasModal.init();
    magze.SearchBlock.init();
    magze.scrollToTop.init();
    magze.setBackgroundImage.init();
    magze.progressBar.init();
    magze.slider.init();
    magze.tabs.init();
    magze.displayTime.init();
    magze.loadPosts.init();
});

window.addEventListener("load", function (event) {
    magze.fadeOutPreloader.init();
});
