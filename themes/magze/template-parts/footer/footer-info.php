...
if ( $enable_copyright || $enable_footer_credit || $enable_footer_nav || $enable_footer_social_nav ) :
	...
	<div class="site-sub-footer<?php echo esc_attr( $wrapper_classes ); ?>">
		<div class="uf-wrapper">
			<div class="magze-footer-siteinfo<?php echo esc_attr( $border_class ); ?>">
					...
					<div class="footer-credits">
						...
						<?php if ( $enable_copyright ) : ?>
							<div class="footer-copyright">
								<?php
								$copyright_text = get_theme_mod( 'copyright_text', esc_html__( 'Copyright &copy; {{ date }}', 'magze' ) );
								if ( $copyright_text ) :
						...
						<?php if ( $enable_footer_credit ) : ?>
							<div class="theme-credit">
								<?php printf( esc_html__( '&nbsp;- Powered by %1$s.', 'magze' ), '<a href="https://unfoldwp.com/products/magze" target = "_blank" rel="designer">Magze</a>' ); ?>
							</div>
					...
					<div class="site-footer-menu footer-nav-menu">
						...
						wp_nav_menu(
							array(
								...
								'fallback_cb'     => false,
								'depth'           => 1,
								'menu_class'      => 'magze-footer-menu reset-list-style',
							)
						);
						?>
					</div>
