<header class="entry-header">
	...
	<?php do_action( 'magze_single_before_header_meta' ); ?>
	...
	<?php do_action( 'magze_single_before_title' ); ?>

	<?php the_title( '<h1 class="entry-title">', '</h1>' ); ?>

	<?php do_action( 'magze_single_after_title' ); ?>
	
	<?php if ( 'post' === get_post_type() ) : ?>
		<?php 
		$show_post_meta_icons = magze_show_single_post_meta_icons( get_the_ID() );
		$meta_settings = array(
	...
	<?php do_action( 'magze_single_after_header_meta' ); ?>
